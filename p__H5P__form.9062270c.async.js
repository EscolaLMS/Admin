(window.webpackJsonp=window.webpackJsonp||[]).push([[12],{"4EEj":function(V,b,e){"use strict";e.d(b,"a",function(){return $});var A=e("+L6B"),F=e("2/Rp"),s=e("q1tI"),y=e("55Ip"),P=e("tMyG"),I=e("pDTe"),f=e("k1fw"),p=e("tJVT"),K=e("KAy6"),H=e("cYju"),t=e("nKUr"),B=function(l){return Object(H.unescape)(l)},S=function(){return Object(t.jsx)("pre",{children:"loading..."})},W=function(l){var d=l.id,u=l.onSubmit,v=Object(s.useState)(100),E=Object(p.a)(v,2),x=E[0],w=E[1],i=Object(s.useRef)(null),L=Object(s.useState)({state:"initial"}),j=Object(p.a)(L,2),g=j[0],M=j[1],h=Object(s.useContext)(I.EditorContext),n=h.state,T=h.getEditorConfig,U=h.submitContent;Object(s.useEffect)(function(){T&&T(d)},[d,T]),Object(s.useEffect)(function(){var m=function(a){if(a.origin===window.location.origin&&(a.data.iFrameHeight&&w(a.data.iFrameHeight),a.data.h5pEditorStatus)){var r=a.data;if(r.h5pEditorStatus==="success"&&n.value==="loaded")return M({state:"loading"}),U&&U(Object(f.a)(Object(f.a)({},r.data),{},{nonce:n.settings.nonce}),d).then(function(o){u&&o&&u(o),M({state:"loaded"})}).catch(function(o){M({state:"error",error:o.toString()})});r.h5pEditorStatus==="error"&&console.log(r.error)}};return window&&window.addEventListener("message",m),function(){window&&window.removeEventListener("message",m)}},[i,U,n,u,d]);var N=Object(s.useMemo)(function(){var m,c,a,r=n.value==="loaded"&&n.settings;if(!r)return"";var o=n.value==="loaded"&&(m=n.settings)!==null&&m!==void 0&&m.contents?(c=n.settings)===null||c===void 0?void 0:c.contents[Object.keys((a=n.settings)===null||a===void 0?void 0:a.contents)[0]]:null,R=o?o.library:"",J=`
