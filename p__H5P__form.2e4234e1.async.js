(window.webpackJsonp=window.webpackJsonp||[]).push([[19],{"4EEj":function(G,h,t){"use strict";t.d(h,"a",function(){return m});var j=t("+L6B"),v=t("2/Rp"),s=t("q1tI"),d=t("55Ip"),g=t("tMyG"),O=t("pDTe"),y=t("k1fw"),I=t("tJVT"),f=t("KAy6"),L=t("cYju"),x=t("nzng"),e=t("nKUr"),w=function(p){return Object(L.unescape)(p)},B=function(){return Object(e.jsx)("pre",{children:"loading..."})},S=function(p){var P=p.id,M=p.onSubmit,_=Object(s.useState)(100),U=Object(I.a)(_,2),R=U[0],K=U[1],b=Object(s.useRef)(null),W=Object(s.useState)({state:"initial"}),D=Object(I.a)(W,2),C=D[0],$=D[1],T=Object(s.useContext)(O.EditorContext),c=T.state,F=T.getEditorConfig,V=T.submitContent;Object(s.useEffect)(function(){F&&F(P)},[P,F]),Object(s.useEffect)(function(){var H=function(u){if(u.origin===window.location.origin){if(u.data.iFrameHeight&&K(u.data.iFrameHeight),u.data.h5pEditorStatus){var r=u.data;if(r.h5pEditorStatus==="success"&&c.value==="loaded")return $({state:"loading"}),Object(x.b)(Object(y.a)(Object(y.a)({},r.data),{},{nonce:c.settings.nonce}),P).then(function(l){M&&l&&l.success&&l.data.id&&typeof l.data.id!="undefined"&&M(l.data),$({state:"loaded"})}).catch(function(l){$({state:"error",error:l.toString()})});r.h5pEditorStatus==="error"&&console.log(r.error)}return null}};return window&&window.addEventListener("message",H),function(){window&&window.removeEventListener("message",H)}},[b,V,c,M,P]);var N=Object(s.useMemo)(function(){var H,E,u,r=c.value==="loaded"&&c.settings;if(!r)return"";var l=c.value==="loaded"&&(H=c.settings)!==null&&H!==void 0&&H.contents?(E=c.settings)===null||E===void 0?void 0:E.contents[Object.keys((u=c.settings)===null||u===void 0?void 0:u.contents)[0]]:null,z=l?l.library:"",Y=`
