...
class FormBuilderComponent extends Component {
  ...
  onDragEnd = (result) => {
      ...
      if (contains('field', result.type)) {
          ...
          this.props.editItem(
              id,
              'options',
              reorder(this.props.elements[id].options, result.source.index, result.destination.index),
          );
          return;
      }
  ...
  render() {
      ...
      return (
          <div className={cx(styles.experiumPlayerBuilder, 'experium-player-builder')}>
              <div className={cx(styles.reactFormBuilder, 'react-form-builder clearfix')}>
                  ...
                  <Modal
                      ...
                      footer={null}
                  >
                      <Settings settings={commonSettings} onSubmit={this.editCommonSettings} />
                  </Modal>
              </div>
          </div>
      );
