...
export enum ExamGradeType {
  ...
  /**
   * AW-44: generated by the backend from a counts_to_grade quiz/project topic, one row per
   * graded item. Never created or graded by hand — see isGeneratedExam. Not offered by
   * ExamForm's type buttons, which are listed explicitly.
   */
  Quiz = 'quiz',
  Project = 'project',
}
