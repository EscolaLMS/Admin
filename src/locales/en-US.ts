...
export default {
  ...
  'user_history.empty': 'This user has no history yet.',
  'user_history.error': 'Could not load history.',
  'user_history.details': 'History details',
  'user_history.details_error': 'Could not load this history record.',
  'user_history.period': 'Period',
  grades: 'Grades',
  ...
  project_max_score_tooltip:
    'Default maximum points for this project, pre-fills the grading input.',
  not_graded: 'Not graded',
  score: 'Score',
  grade_project_solution: 'Grade project',
  ...
  whole_number_between: 'Field must have a whole value between {min} and {max}',
