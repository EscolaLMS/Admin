...
export default {
  ...
  semester: 'Semester',
  egzamTitle: 'Enter an exam title',
  datePassingEgzam: 'Date of passing the exam',
  egzamImportance: 'Exam importance (1-100%)',
  gradesType: 'Select the type of ratings to upload',
  uploadGradesManullay: 'Enter exam grades manually',
  'uploadFile.MsTeams': 'Upload file from MS Teams',
  'uploadFile.MsTeamsForms': 'Upload xlxs file from MS Teams Form',
  'uploadFile.TestPortal': 'Upload xlxs file from TestPortal',
