...
export default {
  ...
  'menu.Other.Questionnaire': 'Questionnaires',
  'menu.Questionnaire Form': 'Questionnaire Form',
  'menu.Other': 'Other',
  'menu.Other.Consultations': 'Consultations',
  'menu.Other.StationaryEvents': 'Stationary Events',
