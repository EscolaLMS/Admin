...
export default {
  ...
  'app.welcome.link.block-list': 'Construisez rapidement des pages standards basées sur le développement de blocs',
  ...globalHeader,
  ...menu,
  ...settingDrawer,
  ...settings,
  ...
  'h5p.description.first': 'Pour assigner un élément HTML5 interactif à un sujet de leçon, vous devez d\'abord le ',
  ...
  rules_tooltip: 'une liste de règles de chaînes JSON utilisées lors de la création/mise à jour du modèle',
  ...
  purchasable_tooltip: 'L\'utilisateur peut-il acheter ce produit ou est-il disponible uniquement par attribution manuelle ?',
  visibility_tooltip:
  ...
  productable: 'Entité',
  all: 'Tout',
  categories_and_tags: 'Catégories et tags',
  course_edit_warning_message:
    "Cet enregistrement est déjà en cours d'édition. Si vous souhaitez le modifier, cliquez sur Confirmer. Vous le faites à vos propres risques.",
  user_logs: 'Journaux d\'utilisateurs',
  http_method: 'Méthode HTTP',
  path: 'Chemin',
  generated_pdfs: 'PDF générés',
  ...
  generate_pdf_for_products_tooltip:
    'Cliquez sur ce bouton pour générer un PDF pour le modèle sélectionné pour tous les utilisateurs qui ont acheté ce produit',
  select_template: 'Sélectionner le modèle',
  product_categories_and_tags: 'Catégories et tags de produits',
  cart_media: 'Médias du panier',
  agenda: 'Agenda',
