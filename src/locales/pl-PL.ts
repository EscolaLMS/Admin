...
export default {
  ...
  subject: 'Przedmiot',
  subjects: 'Przedmioty',
  egzamTitle: 'Wpisz tytuł egzaminu',
  datePassingEgzam: 'Data zaliczenia egzaminu',
  egzamImportance: 'Waga egzaminu (1-100%)',
  gradesType: 'Wybierz typ wgrywanych ocen',
  uploadGradesManullay: 'Wgraj oceny ręcznie',
  'uploadFile.MsTeams': 'Wgraj plik MS Teams wykład',
  'uploadFile.MsTeamsForms': 'Wgraj plik xlxs z MS Teams Form',
  'uploadFile.TestPortal': 'Wgraj plik xlxs z TestPortal',
  'navBar.lang': 'Języki',
