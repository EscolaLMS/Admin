...
export default {
  ...
  'user_history.empty': 'Ten użytkownik nie ma jeszcze historii.',
  'user_history.error': 'Nie udało się wczytać historii.',
  'user_history.details': 'Szczegóły historii',
  'user_history.details_error': 'Nie udało się wczytać tego rekordu historii.',
  'user_history.period': 'Okres',
  grades: 'Oceny',
  ...
  whole_number_between: 'Pole musi mieć wartość całkowitą pomiędzy {min} a {max}',
