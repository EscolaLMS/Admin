export default {
  'pages.layouts.userLayout.title': 'Ant Design est la spécification de conception web la plus influente dans le district de Xihu',
  ...
  'pages.admin.subPage.alertMessage': 'Umi UI est maintenant publié, bienvenue à utiliser "npm run ui" pour commencer l\'expérience.',
